      ...
      >
        {!homeDistrict && (
          <Select value={code} onValueChange={setCode}>
            <SelectTrigger className="w-[220px] bg-panel-2" aria-label="Select district">
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
              {districts.map((d) => (
          ...
          <div className="grid gap-4 lg:grid-cols-[1fr_1.3fr]">
            <Card>
              <CardHeader>
                ...
                <CardTitle className="t-display mt-1 text-[17px]">Final-report breakdown</CardTitle>
              </CardHeader>
              <CardContent>
                {c.outcomes_total ? (
            ...
            <Card>
              <CardHeader>
                ...
                <CardTitle className="t-display mt-1 text-[17px]">Top crime types</CardTitle>
              </CardHeader>
              <CardContent>
                {c.top_crimes.length ? (
                  <div className="space-y-2.5">
          ...
          <Card>
            <CardHeader className="flex-row items-center justify-between space-y-0">
              <div>
                ...
                <CardTitle className="t-display mt-1 text-[17px]">Case load &amp; clearance by officer</CardTitle>
              </div>
              <Badge variant="outline" className="font-mono text-[10px] text-faint">
            ...
            <Card>
              <CardHeader className="flex-row items-center justify-between space-y-0">
                <div>
                  ...
                  <CardTitle className="t-display mt-1 text-[17px]">District ranking by clearance rate</CardTitle>
                </div>
