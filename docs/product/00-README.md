...
| [08 — Field-Officer Intelligence](08-FIELD-OFFICER-INTELLIGENCE.md) | A different question from 07: what would an actual Investigating Officer use daily — statutory deadline tracking, case diary, absconding-accused board, evidence-gap flags — grounded in ER-diagram columns nobody else is using. | deciding what makes it *real* |
